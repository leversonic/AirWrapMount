...
function calculateIndentationCenter(index) = [bodyBackThickness + topShelfDepth / 2, notchDiameter / 2 + topShelfHorizontalPadding + (frontWidth - 2 * topShelfHorizontalPadding - notchDiameter) * index / 3, bodyBackHeight - topShelfVerticalOffset + 0.01];
